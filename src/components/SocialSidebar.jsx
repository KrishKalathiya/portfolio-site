  ...
  return (
    <div className="social-sidebar">
      <ul className="social-sidebar-list">
        <li>
          <a href="https://github.com/krishkalathiya" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://www.linkedin.com/in/krish-kalathiya/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="mailto:kalathkj@mail.uc.edu" aria-label="Email">
